# -*- coding: utf-8 -*-
"""
Code adapted from https://github.com/gohsyi/cluster_optimization for gym API
"""
...
class ClusterOptimizationEnv(gym.Env):
    def __init__(self):
        ...
        self.observation_space = spaces.Box(low=-np.inf, high=np.inf, shape=(self.n_servers * 2 + 3,), dtype=np.float32)
    ...
    def get_reward(self, nxt_task):
        """
        Calculate the reward based on power usage, latency, and task completion penalties.
        """
        penalty_factor = 0.15
