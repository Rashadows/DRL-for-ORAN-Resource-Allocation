...
"""
Script to train SAC with 256 hidden units
Adapted from your ACER implementation for a discrete-action and discrete-state space environment.
"""
import os
import copy
...
directory = "SAC_GPT_preTrained"
os.makedirs(directory, exist_ok=True)

directory = os.path.join(directory, 'resource_allocation')
os.makedirs(directory, exist_ok=True)

checkpoint_path = os.path.join(directory, f"SAC256_resource_allocation_{random_seed}_{run_num_pretrained}.pth")
